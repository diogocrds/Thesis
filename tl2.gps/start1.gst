...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="start1">
        ...
        <node id="n1">
            <attr name="layout">
                <string>209 98 7 18</string>
            </attr>
        </node>
        <node id="n13">
            <attr name="layout">
                <string>496 636 28 18</string>
            </attr>
        </node>
        <node id="n8">
            <attr name="layout">
                <string>438 669 16 18</string>
            </attr>
        </node>
        <node id="n5">
            <attr name="layout">
                <string>616 698 7 18</string>
            </attr>
        </node>
        <node id="n22">
            <attr name="layout">
                <string>200 597 7 18</string>
            </attr>
        </node>
