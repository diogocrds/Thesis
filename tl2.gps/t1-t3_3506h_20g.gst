...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="t1-t3_3506h_20g">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n7">
        ...
        <node id="n34">
            <attr name="layout">
                <string>10 400 53 18</string>
            </attr>
        </node>
        <node id="n35">
            <attr name="layout">
                <string>345 910 35 54</string>
            </attr>
        </node>
        <node id="n36">
            <attr name="layout">
                <string>213 329 49 18</string>
            </attr>
        </node>
        <edge from="n7" to="n7">
            <attr name="label">
