...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="t1-t2_3506h_20g">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n7">
        ...
        <node id="n9">
            <attr name="layout">
                <string>705 502 88 54</string>
            </attr>
        </node>
        <node id="n37">
            <attr name="layout">
                <string>636 603 53 18</string>
            </attr>
        </node>
        <node id="n38">
            <attr name="layout">
                <string>136 937 35 54</string>
            </attr>
        </node>
        <node id="n39">
            <attr name="layout">
                <string>639 404 49 18</string>
            </attr>
        </node>
        <edge from="n7" to="n7">
            <attr name="label">
