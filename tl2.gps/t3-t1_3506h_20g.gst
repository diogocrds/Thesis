...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="t3-t1_3506h_20g">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n16">
        ...
        <node id="n38">
            <attr name="layout">
                <string>200 199 49 18</string>
            </attr>
        </node>
        <node id="n39">
            <attr name="layout">
                <string>322 199 53 18</string>
            </attr>
        </node>
