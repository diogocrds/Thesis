...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="t2-t3_3506h_20g">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n16">
        ...
        <node id="n34">
            <attr name="layout">
                <string>10 389 53 18</string>
            </attr>
        </node>
        <node id="n35">
            <attr name="layout">
                <string>174 306 49 18</string>
            </attr>
        </node>
        <node id="n36">
            <attr name="layout">
                <string>10 740 35 54</string>
            </attr>
        </node>
        ...
        <edge from="n18" to="n34">
            <attr name="label">
                <string>has</string>
            </attr>
        </edge>
        <edge from="n18" to="n35">
            <attr name="label">
                <string>has</string>
            </attr>
        </edge>
