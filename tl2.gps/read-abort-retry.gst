...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="read-abort-retry">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n21">
        ...
        <node id="n33">
            <attr name="layout">
                <string>85 308 49 18</string>
            </attr>
        </node>
        <node id="n34">
            <attr name="layout">
                <string>10 747 35 36</string>
            </attr>
        </node>
        <node id="n35">
            <attr name="layout">
                <string>10 327 53 18</string>
            </attr>
        </node>
        <node id="n37">
            <attr name="layout">
                <string>10 615 68 72</string>
            </attr>
        </node>
        <node id="n38">
            <attr name="layout">
                <string>344 224 69 72</string>
            </attr>
        </node>
        <node id="n40">
            <attr name="layout">
                <string>38 959 68 54</string>
            </attr>
        </node>
        <node id="n42">
            <attr name="layout">
                <string>289 968 68 54</string>
            </attr>
        </node>
        <node id="n43">
            <attr name="layout">
                <string>232 910 49 54</string>
            </attr>
        </node>
