...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="stmhaskell_co_cg.s881">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n379">
        ...
        <edge from="n379" to="n628">
            <attr name="label">
                <string>rf</string>
            </attr>
        </edge>
        <edge from="n379" to="n528">
            <attr name="label">
                <string>ww</string>
            </attr>
        </edge>
