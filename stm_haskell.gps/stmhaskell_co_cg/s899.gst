...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="stmhaskell_co_cg.s899">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n450">
            <attr name="layout">
                <string>50 8 67 126</string>
            </attr>
        </node>
        <node id="n578">
            <attr name="layout">
