...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="stmhaskell_o_cg.s914">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n527">
        ...
        <edge from="n527" to="n627">
            <attr name="label">
                <string>rf</string>
            </attr>
        </edge>
        <edge from="n527" to="n877">
            <attr name="label">
                <string>ww</string>
            </attr>
        </edge>
        <edge from="n627" to="n627">
            <attr name="label">
                <string>type:Tr</string>
            </attr>
        </edge>
